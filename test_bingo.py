...
class TestBingo(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # num 2: prefect data
        self.num2 = [10, 24, 18, 3, 13, 7, 16, 20, 19, 17, 9,
                     22, 1, 5, 6, 11, 15, 12, 2, 23, 21, 14, 0, 4, 8]
    ...
    def test_check_size(self):
        ...
        assert bingo.check_size(num=self.num2, data=self.data) == True
    ...
    def test_bingo_search(self):
        assert bingo.bingo_search(
            num=self.num, data=list(self.data), split=5, success=3) == 20
        assert bingo.bingo_search(
            num=self.num2, data=list(self.data), split=5, success=3) == 13
